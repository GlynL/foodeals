...
<!-- The sections below are optional - include only what a reader actually
     needs. Delete any that don't apply rather than leaving them empty. -->

## Decisions

<!-- Key design decisions with rationale and alternatives considered.
     Only for cross-cutting changes, new dependencies, or real ambiguity. -->
...
<!-- Steps to deploy, rollback strategy - only if this changes deployment or data migration -->

## Open Questions

<!-- Unknowns that can safely be answered later without changing the specs,
     the approach, or the task breakdown. Omit if none. -->
